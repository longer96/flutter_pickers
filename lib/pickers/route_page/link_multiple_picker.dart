...
//
// typedef LinkMultipleCallback(List res);
//
...
// class LinkMultiplePickerRoute<T> extends PopupRoute<T> {
//   LinkMultiplePickerRoute({
//     this.menu,
//     this.menuHeight,
//     this.cancelWidget,
//     this.commitWidget,
...
//   final LinkMultipleCallback onChanged;
//   final LinkMultipleCallback onConfirm;
...
//   }) : super(key: key);
//
//   final Map<dynamic, List> data;
//   final List selectData;
//   final LinkMultipleCallback onChanged;
//   final LinkMultiplePickerRoute route;
//
//   @override
...
//
//   _PickerState(Map<dynamic, List> _data, List mSelectData) {
...
//
//       scrollController1 = new FixedExtentScrollController(initialItem: pindex);
//       scrollController2 = new FixedExtentScrollController(initialItem: pindex);
//     });
//   }
//
//   void _setPicker1() {
...
//               onSelectedItemChanged: (int selectIndex) => _setPicker1(),
