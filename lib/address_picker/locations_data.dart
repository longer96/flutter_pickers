...
/// 获取国际化的"全部"文本
String getAllText(BuildContext context) {
...
class Address {
  ...
  static getCities(String province, BuildContext context) {
    var emptyData = {'name': getAllText(context), 'cityCode': ''};
    if (province == getAllText(context) && addAllItem) return [emptyData];
